...
import { calBisection } from '../containers/calculator'
...
class Bisection extends React.Component{
    ...
    onClickCalculate = e => {
        ...
        try {
            ...
            let {data, pointXL, pointXR} = calBisection(this.state.equation, this.state.xl, this.state.xr, this.state.er)
            let arr = []
            data.map((x, i) => {
                arr.push({
                    key: i+1,
    ...
    render(){
        return(
            <div className="content-layout-background">
                <h1 className="content-header">Bisection Method</h1>
                <div> 
                    <span><Input className="content-equation-input" placeholder="x^4-13" onChange={this.onChangeEquation} value = {this.state.equation}/></span>
                ...
                <div className="content-attribute-input-line">
                    ...
                    <span className="content-attribute-input"><Input placeholder="1.5" onChange={this.onChangeXL} value = {this.state.xl}/></span>
                    <span className="content-text">XR =</span>
                    <span className="content-attribute-input"><Input placeholder="2" onChange={this.onChangeXR} value = {this.state.xr}/></span>
